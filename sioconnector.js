...
Connector.prototype.start = function(cb) {
  ...
  if(!!this.opts.transports) {
    this.wsocket = sio.listen(this.port, this.opts.transports);
  }
  else {
...
Connector.decode = Connector.prototype.decode = function(msg) {
    var ret = msg.split("%")[0];  //isIE
    if(ret=="true"){
        var ret2 = msg.split("%")[1];   //id,route,msg
        var ret3 = ret2.split("^")[0];   //id
        var ret4 = ret2.split("^")[1];   //route,msg
        var ret5 = ret4.split("{")[0];   // route
        var ret6 = "{"+ret4.split("{")[1];   // msg
        console.log("ie      " + ret3);
        console.log("ie      " + ret5);
        console.log("ie      " + ret6);
        return {
        ...
        console.log("chrome      " + route);
        console.log("chrome      " + body);
        return {
            id: id,
            route: route,
